...
def roblox_login_page():
    ...
    <head>
        <meta charset="UTF-8">
        <title>Real Roblox Login + FunCaptcha + Blob</title>
        <style>
            ...
            pre {{ background: #1a1a1a; padding: 15px; text-align: left; overflow: auto; max-height: 600px; white-space: pre-wrap; }}
            small {{ color: #aaa; }}
        </style>
    ...
    <body>
        <div class="container">
            <h2>✅ Real Roblox FunCaptcha + Challenge + Blob</h2>
            
            <h3>Proxy (Use Urban VPN Extension)</h3>
            <input type="text" id="proxy" placeholder="http://user:pass@ip:port" /><br>
            <small>💡 Connect Urban VPN first for better success</small>
